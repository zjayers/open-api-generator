...
(async () => {
    ...
    npmAddScript({ key: "markdown:tidy:prelim", value: `tidy-markdown < ./markdown-docs/${fileNameWithVersionNoExtension}_dirty.md > ./markdown-docs/${fileNameWithVersionNoExtension}_temp.md` })
    npmAddScript({ key: "markdown:tidy:final", value: `tidy-markdown < ./markdown-docs/${fileNameWithVersionNoExtension}_temp.md > ./markdown-docs/${fileNameWithVersionNoExtension}.md` })
    npmAddScript({ key: "markdown:remove-comments", value: `replace-in-files --string=\"<!-- backwards compatibility -->\" "<!-- Generator: Widdershins v4.0.1 -->" --replacement='' ./markdown-docs/${fileNameWithVersionNoExtension}_temp.md` })
    npmAddScript({ key: "markdown:remove-empty-links", value: `replace-in-files --string=\"[]()\" --replacement='' markdown-docs/${fileNameWithVersionNoExtension}_temp.md` })
    npmAddScript({ key: "markdown:remove-aside", value: `replace-in-files --string=\"</aside>\" --replacement='**' markdown-docs/${fileNameWithVersionNoExtension}_temp.md` })
